  ...
  return (
    <div className="flex flex-col  bg-pink h-full  mb-10     max-w-screen-xl mt-10 mx-auto ">
      ...
      <div className="flex flex-col ml-5 mr-5 gap-6 pb-10  ">
        ...
        {/* <div className="flex  w-90p   items-center justify-between ">
          <div className="w-50p">
            <img src={Images.unTicked} alt="" className=" h-5" />{" "}
          </div>
          <div className="w-full gap-4 bg-orange-500 flex items-center">
            <img src={Images.unTicked} alt="" className=" h-5" />
            <div className="text-nowrap"> Andrew Bojangles</div>
          </div>
          <div className="w-full">+79000010101</div>
          <div className="w-full">+79000010101</div>
          <div className="w-full">+79000010101</div>
          <div className="w-full">+79000010101</div>
        </div> */}
